...
function urframework_acf_init() {
    acf_update_setting('google_api_key', 'AIzaSyBRJ2KQAVJRGKNDQdBVZ2xAgx012Q12XtU');
}
...
function urframework_enqueue_global() {
    wp_enqueue_script('globaljs', get_template_directory_uri() . '/js/global-debug.js', array('jquery'), '2.0', TRUE);
    if( is_child_theme() )
        wp_enqueue_script('globaljs-child', get_stylesheet_directory_uri() . '/js/global.js', array('jquery'), '2.0', TRUE);
}

function urframework_enqueue_waypoints() {
    wp_enqueue_script('waypointsjs', get_template_directory_uri() . '/js/jquery.waypoints.min.js', array('jquery'), '1.0', TRUE);
    if( is_child_theme() )
        wp_enqueue_script('waypointsjs-child', get_stylesheet_directory_uri() . '/js/jquery.waypoints.min.js', array('jquery'), '1.0', TRUE);
}
